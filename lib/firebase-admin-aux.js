...
//             return res.boom.unauthorized("Missing authorization");
            return customError(401, "Unauthorized", "Missing authorization");
        }
...
//             return res.boom.badRequest("Malformed authorization");
            return customError(400, "Bad request", "Malformed authorization");
        }
...
//             return res.boom.badRequest("missing auth token");
            return customError(400, "Bad request", "Missing auth token");
        }
    }
